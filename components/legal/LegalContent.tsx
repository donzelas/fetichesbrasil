    ...
    <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
      ...
      <Section title="3. Quais dados coletamos">
        <ul className="ml-5 list-disc space-y-1">
          ...
          <li>
            <strong>Integrações de terceiros</strong>: se você conectar contas de redes
            sociais (ex: TikTok via OAuth), armazenamos apenas tokens de acesso necessários
            para a publicação automatizada, conforme escopo autorizado por você.
          </li>
        </ul>
      </Section>
      ...
      <Section title="6. Compartilhamento com terceiros">
        ...
        <ul className="ml-5 list-disc space-y-1">
          ...
          <li>
            <strong>Plataformas de redes sociais conectadas voluntariamente pelo usuário</strong>
            {" "}(ex: TikTok), exclusivamente para os fins autorizados na conexão OAuth.
          </li>
          <li>
      ...
      <Section title="8. Retenção e descarte">
        <ul className="ml-5 list-disc space-y-1">
          ...
          <li>
            Tokens de integração com redes sociais: enquanto a conexão estiver ativa. O
            usuário pode revogar a qualquer momento, e os tokens serão imediatamente
            descartados.
          </li>
          <li>
      ...
      <Section title="13. Contato">
        <p>
          <strong>E-mail do Encarregado (DPO):</strong> contato@fetichesbrasil.com.br
        </p>
      </Section>
    </div>
  );
    ...
    <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
      ...
      <Section title="5. Responsabilidade do usuário pelo conteúdo">
        ...
        <ul className="ml-5 list-disc space-y-1">
          ...
          <li>Tem o consentimento livre, informado e específico de qualquer pessoa retratada;</li>
      ...
      <Section title="7. Consentimento explícito ao conteúdo adulto">
        <p>Você reconhece e aceita expressamente que:</p>
        <ul className="ml-5 list-disc space-y-1">
          <li>
      ...
      <Section title="14. Integrações com redes sociais (TikTok, Instagram, etc.)">
        <p>
          A plataforma oferece a possibilidade de conectar contas em redes sociais de
          terceiros (ex: TikTok) para fins de divulgação de conteúdo. Ao realizar essa
          conexão, você autoriza expressamente que:
        </p>
        <ul className="ml-5 list-disc space-y-1">
          <li>
            A plataforma armazene os tokens de acesso fornecidos pelo provedor (OAuth)
            exclusivamente para permitir publicação automatizada conforme escopo autorizado;
          </li>
          <li>
            Conteúdos publicados em sua conta da rede social são de sua responsabilidade
            exclusiva, devendo respeitar também os termos da rede social em questão;
          </li>
          <li>
            Você pode revogar a conexão a qualquer momento, no painel da conta ou
            diretamente na configuração de "apps conectados" da rede social;
          </li>
          <li>
            A plataforma não acessa, lê ou compartilha conteúdo privado da sua conta na rede
            social além do estritamente necessário ao escopo autorizado.
          </li>
        </ul>
      </Section>

      <Section title="15. Alterações dos Termos">
        <p>
      ...
      <Section title="16. Foro, lei aplicável e resolução de conflitos">
        <p>
      ...
      <Section title="17. Disposições finais">
        <ul className="ml-5 list-disc space-y-1">
          <li>
